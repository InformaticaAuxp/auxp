        ...
        <div id="formulario" class="obj_center_Q med_width_Q">
          ...
          <?php 
            ...
            if($reg<>null){
              ...
              echo "<br><br><strong> Fecha: </strong>".$fecharecibido; $idclasificacion = 'A';
              $cadena=implode(";", $municipio);
              echo "<br><br><strong> Municipio: </strong>". $cadena;
              echo "<br>";}
            ...
            echo $query = "INSERT INTO sugerencia_aceptada (CODIGO,EXPEDIENTE,PRIMER_NOMBRE,SEGUNDO_NOMBRE,PRIMER_APELLIDO, SEGUNDO_APELLIDO,DPI,CORREO,TELEFONO,SEXO,PROFESION,DIRECCION,SUGERENCIA,FECHARECIBIDO,IDTIPOASOCIADO, IDSOLICITUDENVIO,IDCLASIFICACION, IDMUNICIPIO) VALUES('$codigo','$expediente','$nombre1','$nombre2','$apellido1','$apellido2','$dpi','$correo','$telefono','$sexo','$profesion','$direccion','$sugerencia','$fecharecibido','$idtipoasociado','$idsolicitudenvio','$idclasificacion','$cadena')";
