...
<html lang="Es">
	<head>
		...
		<link rel="stylesheet" href="css/contdownload.css">
...
<body id="descargas">
		<div class="rescontainer">
			<div class="hidcontainer">
				...
				<!-- 	-CONTENIDO- 	-->
				<div><h1>Descargas</h1></div>
				<!-- 	-DESCARGAS- -->
				
				<div id="downl" class="med_width_dow obj_center_dow">
                    <!-- ASOCIACION -->
                    <a class="boxin" href="download/estatutos/estatutos_y_reglamento_general.pdf" download="Estatutos y Reglamento General.pdf">Estatutos y Reglamento</a>
                    <!-- SECRETARIA -->
                    <a class="boxin" href="download/departamento%20de%20secretaria%20general/Formularios_Requisitos_Secretaria_General.zip" download="Formularios y Requisitos Departamento de Secretaria General.zip">Formularios Y Requisitos Departamento De Secretaria General<div class="efect"></div></a>
                    <!-- CREDITOS -->
                    ...
                    <a class="boxin" href="download/departamento%20de%20trabajo%20social/programa_ayuda_economica_requisitos_solicitud.zip" download="Formulario y Requisitos de Ayuda Economica.zip">Programa de Ayuda Económica Por Fallecimiento De Cónyuge e Hijo Menor De Edad</a>
                    <a class="boxin" href="download/departamento%20de%20trabajo%20social/REQUISITOS%20PROGRAMA%20DE%20BENEFICIO%20POR%20ENFERMEDAD%20CONCOMITANTES%20Y%20CON%20RIESGO%20DE%20MUERTE.pdf" download="REQUISITOS PROGRAMA DE BENEFICIO POR ENFERMEDAD TERMINAL CONCOMITANTES Y CON RIESGO DE MUERTE.pdf">Requisitos de Programa de Enfermedad Terminal</a>
